...
/**
 * 微信图片审核结果表 - 管理端通用 CRUD
 */
@RestController
@RequestMapping("/adminapi/media_check")
@Tag(name = "微信图片审核结果表")
public class MediaCheckAdminController extends BaseController {

    @Autowired
    protected MediaCheckService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody MediaCheck entity) {
