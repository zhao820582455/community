 ...
 */
@RestController
@RequestMapping("/adminapi/discuss")
@Tag(name = "话题/讨论表")
public class DiscussAdminController extends BaseController {

    @Autowired
    protected DiscussService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody Discuss entity) {
