 ...
 */
@RestController
@RequestMapping("/adminapi/likes")
@Tag(name = "帖子点赞表")
public class LikesAdminController extends BaseController {

    @Autowired
    protected LikesService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody Likes entity) {
