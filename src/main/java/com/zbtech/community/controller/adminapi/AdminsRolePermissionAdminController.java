 ...
 */
@RestController
@RequestMapping("/adminapi/role_permission")
@Tag(name = "角色菜单关联表")
public class AdminsRolePermissionAdminController extends BaseController {

    @Autowired
    protected AdminsRolePermissionService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody AdminsRolePermission entity) {
