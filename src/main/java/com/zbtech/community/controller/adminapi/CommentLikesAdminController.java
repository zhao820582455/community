 ...
 */
@RestController
@RequestMapping("/adminapi/comment_likes")
@Tag(name = "评论点赞表")
public class CommentLikesAdminController extends BaseController {

    @Autowired
    protected CommentLikesService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody CommentLikes entity) {
