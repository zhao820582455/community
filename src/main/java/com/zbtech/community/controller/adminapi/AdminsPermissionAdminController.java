...
@Tag(name = "菜单/接口权限表")
public class AdminsPermissionAdminController extends BaseController {

    @Autowired
    protected AdminsPermissionService service;
    ...
    @PostMapping("/save")
    public Result<?> save(@RequestBody AdminsPermission entity) {
